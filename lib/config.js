...
function loadEnvConfig() {
  ...
  const envMapping = {
    ...
    'COVERAGE_PREVIOUS_REPORT': 'previousReport'
  };
  ...
  if (process.env.SCRY_COVERAGE_PREVIOUS_REPORT !== undefined && process.env.SCRY_COVERAGE_PREVIOUS_REPORT !== '') {
    envConfig.previousReport = process.env.SCRY_COVERAGE_PREVIOUS_REPORT;
  }
