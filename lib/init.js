...
3. Add these Variables (Variables tab):
   ...
   • SCRY_API_URL = ${apiUrl}
   • SCRY_VIEW_URL = http://view.scrymore.com (optional, defaults to this)
...
Or install GitHub CLI and run:
   ...
   gh variable set SCRY_VIEW_URL --body "http://view.scrymore.com"
...
🌐 Deployment URLs:
   • Production: http://view.scrymore.com/${projectId}/latest/
   • PR Previews: http://view.scrymore.com/${projectId}/pr-{number}/
