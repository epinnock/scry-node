 ...
 * Returns a robust install command that handles missing lockfiles
 */
function getInstallCommand(packageManager) {
    switch (packageManager) {
        ...
        case 'pnpm':
            // Use frozen-lockfile when lockfile exists, otherwise regular install
            return 'if [ -f pnpm-lock.yaml ]; then pnpm install --frozen-lockfile; else pnpm install; fi';
        case 'yarn':
            // Use frozen-lockfile when lockfile exists
            return 'if [ -f yarn.lock ]; then yarn install --frozen-lockfile; else yarn install; fi';
        case 'bun':
            // Bun handles lockfile automatically
            return 'bun install';
        default:
            return 'npm install';
    }
